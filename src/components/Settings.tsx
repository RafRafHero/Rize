...
export const Settings: React.FC = () => {
    ...
    const setActiveSection = (section: 'general' | 'bookmarks' | 'appearance' | 'passwords' | 'performance') => {
    ...
    const TabButton = ({ id, label, icon: Icon }: any) => (
        <button
            ...
            className={cn(
                "px-6 py-3 text-sm font-medium border-b-2 transition-all flex items-center gap-2 relative",
                activeSection === id ? "text-primary bg-primary/5" : "border-transparent text-muted-foreground hover:text-foreground hover:bg-secondary/30"
            )}
        >
            <Icon size={16} /> {label}
            {activeSection === id && (
    ...
    return (
        <div className="flex flex-col h-full bg-background overflow-hidden">
            ...
            <div className="flex px-8 border-b border-border/50 bg-secondary/5 scrollbar-hide overflow-x-auto">
                <TabButton id="general" label="General" icon={Monitor} />
                <TabButton id="appearance" label="Appearance" icon={Sparkles} />
                <TabButton id="performance" label="Performance" icon={Moon} />
                        ...
                        {activeSection === 'general' ? (
                                    ...
                                    <div className="ml-7 space-y-4">
                                        <div className="grid grid-cols-1 gap-4">
                                            ...
                                            <ShortcutRecorder
                                                ...
                                                value={settings.keybinds?.commandPalette || 'CommandOrControl+K'}
                                                onSave={(newVal) => {
                                                    updateSettings({
                                                        keybinds: { ...settings.keybinds, commandPalette: newVal }
                                                    });
                                                    (window as any).rizoAPI?.ipcRenderer.send('update-shortcuts');
                                                }}
                                            />
                            ...
                            <div className="space-y-8">
                                ...
                                <section className="space-y-4">
                                    <div className="flex flex-col">
                                        <h3 className="text-base font-semibold flex items-center gap-2">
                                            <Moon size={18} className="text-primary" /> Performance & Resources
                                        </h3>
                                        <p className="text-xs text-muted-foreground ml-7">Optimize browser speed and system resource usage</p>
                                    </div>
                                    ...
                                    <div className="ml-7 space-y-4">
                                        ...
                                        <div className="p-4 rounded-2xl border border-border/40 bg-secondary/10 backdrop-blur-md">
                                            <div className="flex items-center justify-between">
                                                <div className="flex flex-col">
                                                    <span className="text-sm font-medium">Tab Hibernation</span>
                                                    <span className="text-[10px] text-muted-foreground">Automatically put inactive tabs to sleep to save RAM</span>
                                                </div>
                                                <motion.button
                                        ...
                                        <AnimatePresence>
                                            {settings.tabSleepEnabled && (
                                                ...
                                                >
                                                    <div className="p-4 rounded-2xl border border-border/40 bg-secondary/10 backdrop-blur-md mt-2">
                                        ...
                                        <div className="p-4 rounded-2xl border border-border/40 bg-secondary/10 backdrop-blur-md">
                                            <div className="flex items-center justify-between">
                                                <div className="flex flex-col">
                                                    <span className="text-sm font-medium">Clear Browser Data</span>
                                                    <span className="text-[10px] text-muted-foreground">Clear cached images, files, and cookies</span>
                                                </div>
                                                <motion.button
                                                    whileHover={{ scale: 1.05 }}
                                                    whileTap={{ scale: 0.95 }}
                                                    ...
                                                    className="px-4 py-2 text-xs font-medium bg-destructive/10 text-destructive hover:bg-destructive hover:text-destructive-foreground rounded-lg transition-all border border-destructive/20"
                                                >
                                                    Clear Cache
                                                </motion.button>
                                            </div>
                                        ...
                                        {(['light', 'dark'] as const).map((t) => (
                                            ...
                                            >
                                                ...
                                                <div className="flex flex-col items-start">
                                                    ...
                                                    <span className="text-[10px] text-muted-foreground">{`Standard ${t} UI`}</span>
                                                </div>
                                                {settings.theme === t && (
